...
const Signup = () => {
  ...
  return (
    <div className="h-vh flex flex-col justify-center items-center p-4 md:p-8">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col sm:w-[30rem] bg-card-bg p-8 md:p-16 rounded-2xl shadow-lg">
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="">
            ...
            <button onClick={() => navigateto("/login")} type="button" className="text-blue hover:underline hover:cursor-pointer">
              Login
            </button>
          </div>
